...
*High-dimensional data* are defined as data with many features (variables observed), $p$.
...
blood test results, behaviours, and general health, resulting in a dataset with
many features. An example of what high-dimensional data might look like 
