...
> 
> ```{r corr-mat-meth, fig.cap="A feature-feature correlation heatmap of methylation data.", fig.alt="A heatmap showing pairwise feature-feature correlations in a methylation dataset. Red corresponds to large positive correlations and blue to large negative correlations. There are a number of large blocks of highly (positively or negatively) correlated features."}
> library("ComplexHeatmap")
