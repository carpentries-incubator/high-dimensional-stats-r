...
We can see that cross-validation has selected a value of $\lambda$ resulting in `r length(selected_coefs)` features (including the intercept. 
We can cross reference these with the hovarth data to compare features:
