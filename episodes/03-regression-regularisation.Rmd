...
```{r heatmap-lasso, echo = FALSE, fig.cap="Heatmap showing methylation values for the selected CpG and how they vary with age.", fig.alt="Overall, we observe either increasing or decreasing methylation patterns as a function of age."}
