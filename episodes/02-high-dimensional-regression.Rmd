...
In general, it is scientifically interesting to answer two main questions using the three types of data:

1. To predict methylation levels using age as a predictor. In this case, we 
would have 5000 outcomes (methylation levels across the genome) and a single 
covariate (age). 

2. To predict age using methylation levels as predictors. In this case, we would 
...
> ## Challenge 1
>
> For the problem in (1) above, why can we not just fit many linear regression models, one for each of the columns
