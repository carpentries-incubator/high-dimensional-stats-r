...
The first principal component's scores ($Z\_1$) are calculated using the equation:

$$  
Z_1 = a_{11}X_1 + a_{21}X_2 +....+a_{p1}X_p
$$

$X\_1...X\_p$ represents variables in the original dataset and $a\_{11}...a\_{p1}$
...
```{r stats-biplot, fig.cap="Caption"}
...
```{r pca-biplot-ex2, fig.cap="Caption"}
  PCAtools::biplot(pc,
