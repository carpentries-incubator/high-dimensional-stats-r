...
matrix for use within the **`PCAtools`** package. We set the `scale = TRUE` argument
...
PCAtools::biplot(pca.pros, lab=NULL, singlecol=TRUE) #plot biplot using a single colour for the points
```
