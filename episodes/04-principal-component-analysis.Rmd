...
Let's use the **`PCAtools`** package to perform PCA on the scaled `prostate` data. Let's load the **`PCAtools`** package and the data.
...
The input data (`pros2`) is in the form of a matrix and we set the `scale = TRUE` argument
