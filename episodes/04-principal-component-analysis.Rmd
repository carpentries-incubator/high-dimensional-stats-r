...
PCA transforms a dataset into a new set of uncorrelated variables called "principal components". The first principal component derived explains the largest amount of the variability
