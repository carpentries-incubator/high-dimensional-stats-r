...
by the model. As such, $y_i-x'_i\beta$ can be interpreted as the prediction error.
To quantify the total error across all individuals, we sum the square residuals 
