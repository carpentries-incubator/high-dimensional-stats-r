...
data structures for computational biology in R generally), samples are stored as
columns and features are stored as rows. This is in contrast to usual tabular data, where features or variables
...
`r nrow(methylation)` _features_ and `r ncol(methylation)` _columns_. To
