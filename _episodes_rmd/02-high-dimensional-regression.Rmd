...
object that contains lots of different information about the data. 
These objects are very useful for storing all of the information 
about a dataset in a high-throughput context. In this case, `methylation`
contains `assay`s providing normalised methylation levels, `colData` providing 
sample-level information and `metadata` providing feature-level information.
The structure of `SummarizedExperiment` objects is described in the [vignettes on
