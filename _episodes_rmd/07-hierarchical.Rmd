...
```{r clust-euc-cor-example, fig.cap="Dendogram of the example simulated data.", fig.alt="A dendogram of the example simulated data. The dendogram shows that sample c definitely forms its own cluster for any cut height and sammples b and a merge into a cluster at a height of around 6."}
