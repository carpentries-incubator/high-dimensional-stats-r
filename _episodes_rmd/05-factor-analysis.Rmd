...
The last episode dealt with one method to achieve this, called principal component analysis (PCA). Here, we
introduce another method called *factor analysis* (FA).
...
variation in a dataset, they can run a CFA, specifying which features are thought
