...
variance in the data (>50%), the first two principal components
explain >70% of variance in the data, and and each subsequent principal component explains
less and less of the total variance.
