...
explain most of the variation in the dataset.
...
there is greatest variability in the data. Finding the location on the line
closest to a given data point would yield a vector of points with the 
greatest possible variance. The next highest amount
of variability in the data is represented by the line perpendicular to the first
regression line, which represents the uncorrelated second principal component (green line).
