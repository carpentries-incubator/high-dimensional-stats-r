...
$n$, far outnumbers the number of features, $p$. A related concept is *wide data*.
This refers to data with numerous features irrespective of the number of observations.
Analyses of high-dimensional data require consideration of potential problems that
come from having a large number of features. 
