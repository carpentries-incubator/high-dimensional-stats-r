...
than collecting many features from a single observation). As such, high-dimensional
...
the large number of explanatory variables makes doing this difficult. In addition, in some
