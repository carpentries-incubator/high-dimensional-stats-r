...
> > ## Solution
> > 
> > 1. No. The number of features is relatively small (3).
> > 2. Yes, this is an example of high-dimensional data. There are 200,000+3 features.
> > 3. No. The number of features is relatively small (5).
> > 4. Yes. There are 20,000 features.
> {: .solution}
{: .challenge}
