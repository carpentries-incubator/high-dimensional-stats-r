...
> ## Challenge 6
> 
> Use `colby` and `lab` arguments in `biplot` to explore whether these two groups may cluster by patient age or by whether or not the sample expresses the estrogen receptor gene (ER+ or ER-).
> 
> > Solution:
> > 
> > ```{r, fig.cap="Caption", fig.cap="Alt"}
