...
## graph-based
g <- buildSNNGraph(scrnaseq, k = 10, use.dimred = "PCA")
clust <- igraph::cluster_walktrap(g)$membership
reducedDim(scrnaseq, "force") <- igraph::layout_with_fr(g)
colLabels(scrnaseq) <- factor(clust)
plotReducedDim(scrnaseq, colour_by = "label", dimred = "force")
# ```
